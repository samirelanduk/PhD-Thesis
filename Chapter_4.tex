...
\emph{Note that some of the material in this chapter has been published in the journal Database under the title `ZincBind—the database of zinc binding sites' (2019) \cite{ireland2019}, though the values and analysis have been updated for the updated dataset.}
